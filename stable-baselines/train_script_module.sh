...
# then
    ...
    python train.py --algo ppo2 --env QuadRate-v0 --tensorboard-log ~/workspace/openai_train_scripts/stable-baselines/log/ --log-folder ~/workspace/openai_train_scripts/stable-baselines/model
    cd $CURR_DIR
