...
# elif [ "$#" -eq 4 ]
# then
    #ENV_NAME=BallBouncingQuad-v0 #BallBouncingQuad-v0 #QuadRate-v0
    # MODEL_SAVE_PATH=$1
    # LOG_PATH=$2
    # N_STEP=$3
    # N_ENV=$4
    ...
    python train.py --algo ppo2 --env QuadDirect-v0 --tensorboard-log ~/workspace/openai_train_scripts/stable-baselines/log/ --log-folder ~/workspace/openai_train_scripts/stable-baselines/model
    cd $CURR_DIR
